...
export default function Marquee() {
  ...
  <div className="relative z-10 flex flex-col items-center gap-12">
    ...
    >
        ...
        <div className="flex gap-6 animate-marquee group-hover:[animation-play-state:paused] py-4">
          ...
          {[...rowA, ...rowA].map((item, index) => (
            ...
            <div
              ...
              "
            >
              <div className="text-2xl flex items-center justify-center text-indigo-600">
                {icons[item.icon]}
              </div>
            </div>
      ...
      {/* Row 2 */}
      <div className="group overflow-hidden mt-2">

        <div className="flex gap-6 animate-marquee-reverse group-hover:[animation-play-state:paused] py-4">
          ...
          {[...rowB, ...rowB].map((item, index) => (
            ...
            <div
              ...
              "
            >
              <div className="text-2xl flex items-center justify-center text-cyan-600">
                {icons[item.icon]}
              </div>
            </div>
